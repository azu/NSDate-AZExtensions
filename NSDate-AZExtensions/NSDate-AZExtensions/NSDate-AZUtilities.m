...
- (BOOL)isEarlierThanDateByTime:(NSDate *) aDate {
    ...
    NSDateComponents *components2 = [calendar components:flags fromDate:aDate];
    NSDate *time1 = [calendar dateFromComponents:components1];
    NSDate *time2 = [calendar dateFromComponents:components2];
    return [time1 isEarlierThanDate:time2];
}

- (BOOL)isLaterThanDateByTime:(NSDate *) aDate {
    unsigned int flags = NSHourCalendarUnit | NSMinuteCalendarUnit | NSSecondCalendarUnit;
    NSCalendar *calendar = CURRENT_CALENDAR;
    NSDateComponents *components1 = [calendar components:flags fromDate:self];
    NSDateComponents *components2 = [calendar components:flags fromDate:aDate];
    NSDate *time1 = [calendar dateFromComponents:components1];
    NSDate *time2 = [calendar dateFromComponents:components2];
    return [time1 isLaterThanDate:time2];
}
#pragma mark Roles
